...
public final class Constants {
    ...
    //常用的数学符号
    public static final String NUMBER_SYMBOL = "①②③④⑤⑥⑦⑧⑨⑩㈠㈡㈢㈣㈤㈥㈦㈧㈨㈩№" + "⑴⑵⑶⑷⑸⑹⑺⑻⑼⑽⑾⑿⒀⒁⒂⒃⒄⒅⒆⒇" + "ⅠⅡⅢⅣⅤⅥⅦⅧⅨⅩⅪⅫⅰⅱⅲⅳⅴⅵⅶⅷⅸⅹ";
    ...
    /**
     * 18位身份证中，各个数字的生成校验码时的加权因子
     */
    public static final int[] VERIFY_ID_NUMBER_WEIGHT = {7, 9, 10, 5, 8, 4, 2, 1, 6, 3, 7, 9, 10, 5, 8, 4, 2};
    /**
     * 身份证号码计算因子
     */
    public static final int VERIFY_ID_NUMBER_DIVISOR = 11;
    /**
     * 对应校验码字符值
     */
    public static final char[] VERIFY_ID_NUMBER_VALIDATE={ '1','0','X','9','8','7','6','5','4','3','2'};

    /**
     * 星座对应的分割日期
     */
    public static final int[] CONSTELLATION_DAYS = {20, 19, 21, 20, 21, 22, 23, 23, 23, 24, 23, 22};
    /**
     * 对应的星座
     */
    public static final String[] CONSTELLATION_STRINGS = {"水瓶座", "双鱼座", "白羊座", "金牛座", "双子座", "巨蟹座", "狮子座", "处女座", "天秤座", "天蝎座", "射手座", "摩羯座"};
}
