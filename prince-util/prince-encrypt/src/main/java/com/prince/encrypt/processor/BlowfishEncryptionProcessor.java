 ...
 * Blowfish加密算法Java实现
 */
public class BlowfishEncryptionProcessor {
    ...
    public BlowfishEncryptionProcessor() {
        S0 = new int[SBOX_SK];
        S1 = new int[SBOX_SK];
        S2 = new int[SBOX_SK];
        S3 = new int[SBOX_SK];
...
*/
    ...
    */
    ...
    public final static byte[] encrypt(String key, String str) {
        BlowfishEncryptionProcessor bf1 = new BlowfishEncryptionProcessor();
        bf1.init(true, key.getBytes());
        return bf1.encrypt(str);
    }

    public final static String decrypt(String key, byte[] tt) {
        BlowfishEncryptionProcessor bf2 = new BlowfishEncryptionProcessor();
    ...
    public static String encode(String text) {
        return new String(encrypt(SECRET_KEY, text));
    }

    public static String decode(String text) {
        return new String(decrypt(SECRET_KEY, text.getBytes(StandardCharsets.UTF_8)));
    }
}
