 ...
 * ASE加密
 */
public final class ASEEncryptionProcessor {
     ...
     * 	3.将加密内容解密
     */
    public static String AESDecode(final String encodeRules, String content) {
        try {
            // 1.构造密钥生成器，指定为AES算法,不区分大小写
            KeyGenerator keygen = KeyGenerator.getInstance("AES");
            // 2.根据ecnodeRules规则初始化密钥生成器
    ...
    public static String encode(String Str) {
        return AESEncode(SECRET_KEY, Str);
    }
    ...
    public static String decode(String str) {
        return AESDecode(SECRET_KEY, str);
    }

    public static void main(String[] args) {
//        System.out.println(encode("15112341234"));
        System.out.println(decode("jwYymxRCZ395ZBBWjtrsnQ=="));
    }
}