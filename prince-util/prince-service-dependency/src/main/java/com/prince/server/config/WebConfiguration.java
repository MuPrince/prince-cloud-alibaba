...
import com.prince.server.interceptor.ApiVersionInterceptor;
import com.prince.server.interceptor.UserInterceptor;
...
public class WebConfiguration implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        // 拦截器
        registry.addInterceptor(this.userInterceptor()).excludePathPatterns("/error", "/sys/user/login", "/login");
        registry.addInterceptor(this.apiVersionInterceptor());
