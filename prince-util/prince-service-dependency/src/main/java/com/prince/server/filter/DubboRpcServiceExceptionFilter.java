...
/**
 * Description : dubbo Rpc调用自定义异常处理过滤器 <br/>
 * 代码为直接复制{@link org.apache.dubbo.rpc.filter.ExceptionFilter} <br/>
 * 在73行处加入自定义异常抛出逻辑 <br/>
 * 在 META_INF/dubbo/org.apache.dubbo.rpc.Filter文件中加入exception=com.prince.server.filter.DubboRpcServiceExceptionFilter
 * 覆盖{@link org.apache.dubbo.rpc.filter.ExceptionFilter}
 *
 * @author Mu Prince <br\>
 * @since 2022/8/4 14:43
 */
@Slf4j
@Activate(group = {CommonConstants.PROVIDER})
public class DubboRpcServiceExceptionFilter implements Filter, Filter.Listener {
